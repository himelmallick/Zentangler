...
HPC scripts are installed with the package:

```r
system.file("scripts/make_intersim_hpc_grid.R", package = "Zentangler")
system.file("scripts/run_intersim_hpc_task.R", package = "Zentangler")
```
